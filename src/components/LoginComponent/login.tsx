  ...
  return (
    ...
    <div className="grid place-items-center mt-40">
      ...
      <form action="get" className="flex flex-col p-0 m-0 ">
        ...
        <button type="submit" className="rounded-[20px] border-2 border-[#1F2B3D] border-solid bg-[#1F2B3D] text-white pb-2 pt-2 mt-5">Sign in</button>
      </form>
      <div className="flex flex-col mt-10">
      <Link href="/" className="mt-2 mb-2">I CAN&apos;T REMEMBER MY PASSWORD</Link>
      <Link href="/" className="mt-2 mb-2">I DON&apos;T HAVE AN ACCOUNT!</Link>
      </div>
      </div>
    </div>
    </>
