        ...
        <div className="flex items-center justify-center flex-col w-[50vh] h-[80vh] text-[#1F2B3D] text-center border-6 rounded-[20px] border-[#1F2B3D] border-solid mt-10 ">
          <form action="post" className="flex flex-col p-0 m-0 ">
            ...
            <input
              ...
              className="border-2 rounded-[20px] border-[#1F2B3D] border-solid pb-2"
            />
            <p id="uppercase" className="pb-2 pt-5 text-left">
              Least 1 upperacase
            </p>
            <p id="specialCharacter" className="pb-2 pt-2 text-left">
              Least 1 special character
            </p>
            <p id="number" className="pb-2 pt-2 text-left">
              Least 1 number
            </p>
            <p id="characterLong" className="pb-2 pt-2 text-left">
