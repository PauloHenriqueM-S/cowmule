  ...
  return (
    <>
      <div className="grid place-items-center mt-[100px] w-[100vw] h-[70vh] text-[#1F2B3D]">
        <form
          action="post"
          className="flex flex-col justify-between h-[40vh] w-[40vh]"
        >
          <section id="social" className="flex flex-row justify-between">
            <label htmlFor="social name" className="pb-2 pt-2">
              SOCIAL NAME
            </label>
            <input
              type="text"
          ...
          >
            ...
            <Image
              ...
              width={50}
              height={50}
              className="border-2 rounded-[50px] border-[#1F2B3D] border-solid"
            />
            <p>New Avatar</p>
          </section>
          ...
          >
            ...
            <select
              name="Language"
              id="language"
              className="border-2 rounded-[20px] border-[#1F2B3D] border-solid"
            >
        ...
        <div className="flex flex-row">
          <button
            type="reset"
            className="border-2 rounded-[20px] border-[#1f2b3d] border-solid bg-[#1f2b3d] pr-2.5 pl-2.5 mr-5 text-white"
          >
            DISCARD
          </button>
          <button
